using MiniStoreWorkshopAntiPatterns;
...
namespace MiniStoreWorkshopSOLID
{
    namespace MiniStoreWorkshopSOLID
    {
        public class Program
        {
            ...
            {
                Console.WriteLine("MiniStore Workshop - Refactor SOLID");

                var app = new OrderService(new ConsoleNotifier(), new FileOrderRepository());
                app.Seed();
                ...
                Console.WriteLine("Fin del taller SOLID.");
            }
        }
    }
}
